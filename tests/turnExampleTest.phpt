...
--EXPECTF--
Start of game
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Setup\PlayerSetup'.
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Setup\StartingSpaceships'.
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Setup\StartingCredit'.
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Setup\StartingDeuterium'.
Publish event '{"name":"player_joined_game","player":100}' to listener 'StarLord\Domain\Model\Setup\StartingColons'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Setup\PlayerSetup'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Setup\StartingSpaceships'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Setup\StartingCredit'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Setup\StartingDeuterium'.
Publish event '{"name":"player_joined_game","player":200}' to listener 'StarLord\Domain\Model\Setup\StartingColons'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Setup\PlayerSetup'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Setup\StartingSpaceships'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Setup\StartingCredit'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Setup\StartingDeuterium'.
Publish event '{"name":"player_joined_game","player":300}' to listener 'StarLord\Domain\Model\Setup\StartingColons'.
...
Publish event '{"name":"card_was_played","player_id":100,"card_id":1010}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"card_was_played","player_id":200,"card_id":1005}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"card_was_played","player_id":300,"card_id":1000}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
...
Turn 2
Publish event '{"name":"turn_was_started"}' to listener 'StarLord\Domain\Model\Bonus\CollectResourcesFromPlanets'.
Publish event '{"name":"turn_was_started"}' to listener 'StarLord\Domain\Model\Bonus\CollectResourcesFromCrystals'.
{"id":100,"population":1,"hand":[1011,1012,1013,1014,1015],"credit":8,"deuterium":5,"transports":4,"fighters":1,"cruisers":0,"crystals":[]}
{"id":200,"population":2,"hand":[1006,1007,1008,1009,1016],"credit":8,"deuterium":5,"transports":2,"fighters":1,"cruisers":0,"crystals":[]}
...
Publish event '{"name":"card_was_played","player_id":100,"card_id":1011}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"card_was_played","player_id":200,"card_id":1006}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
Publish event '{"name":"card_was_played","player_id":300,"card_id":1001}' to listener 'StarLord\Domain\Model\Commands\DrawCardHandler'.
